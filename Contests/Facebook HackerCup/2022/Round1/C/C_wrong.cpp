...
vector<point> getConvexHull(vector<point> &points) {
    ...
    for (int i = 2; i < points.size(); i++) {
        ...
        while(upperHull.size() > 1) {
            point a = upperHull[int(upperHull.size()) - 2];
            point b = upperHull[int(upperHull.size()) - 1];


            int64_t value = cross_product(a, b, c);
    ...
    for (int i = 2; i < points.size(); i++) {
        ...
        while(lowerHull.size() > 1) {
            point a = lowerHull[int(lowerHull.size()) - 2];
            point b = lowerHull[int(lowerHull.size()) - 1];


            int value = cross_product(a, b, c);
