...
void run_cases() {
    ...
    Matrix<mod_int, 6> initial;
    Matrix<mod_int, 6> base;
...
int main() {
    ...
    /*For validation*/
    // freopen("a3_validation_input.txt", "r", stdin);
    // freopen("a3_validation_output.txt", "w", stdout);

    /*For final submit*/
    freopen("a3_final_input.txt", "r", stdin);
    freopen("a3_final_output.txt", "w", stdout);
