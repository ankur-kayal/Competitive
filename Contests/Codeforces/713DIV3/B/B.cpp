...
void run_cases() {
    ...
    if(pts[0].first == pts[1].first) {
        if(pts[0].first == 0) {
            a[pts[0].first + 1][pts[1].second] = '*';
            a[pts[1].first + 1][pts[0].second] = '*';
        } else {
            a[pts[0].first - 1][pts[1].second] = '*';
            a[pts[1].first - 1][pts[0].second] = '*';
        }
        ...
        if(pts[0].second == 0) {
            a[pts[0].first][pts[1].second + 1] = '*';
            a[pts[1].first][pts[0].second + 1] = '*';
        } else {
            a[pts[0].first][pts[1].second - 1] = '*';
            a[pts[1].first][pts[0].second - 1] = '*';
        }
    } else {
        a[pts[0].first][pts[1].second] = '*';
        a[pts[1].first][pts[0].second] = '*';
    }
