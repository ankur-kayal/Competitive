...
template <typename T>
void BuildDivisorsFromFactors(const vector<pair<T, int>>& factors, long long limit, long long& ans) {
  static vector<long long> divisors;
  divisors.assign(1, 1);
  for (auto& p : factors) {
